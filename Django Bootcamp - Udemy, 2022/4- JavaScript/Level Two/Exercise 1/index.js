...
function sleepIn(weekday, vacation) {
    return (!weekday || vacation)  // It's not a weekday OR vacation ?
}
...
function monkeyTrouble(aSmile, bSmile) {
    return (aSmile && bSmile) || (!aSmile && !bSmile) // Firstyle we check if both are smiling, and later we checck if they aren't.
}
...
// One line teacher solution: return goal%5 >= 0 && goal%5 - small <= 0 && small + 5*big >= goal;